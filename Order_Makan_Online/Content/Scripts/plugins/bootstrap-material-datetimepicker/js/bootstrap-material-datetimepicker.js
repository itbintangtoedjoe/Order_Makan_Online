! function (t, e) {
    ...
    e.locale("en"), t.fn[i] = function (e, i) {
        return this.each(function () {
            t.data(this, a) ? ("function" == typeof t.data(this, a)[e] && t.data(this, a)[e](i), "destroy" === e && t.data(this, a)) : t.data(this, a, new s(this, e))
        }), this
    }, s.prototype = {
        init: function () {
        ...
        initTemplate: function () {
            ...
            this.midYear = i;
            var s = '<div class="dtp-picker-year hidden" ><div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range before" style="margin: 0;"><i class="ti-angle-up"></i></a></div>' + e + '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range after" style="margin: 0;"><i class="ti-angle-down"></i></a></div></div>';
        ...
        initDate: function (t) {
            ...
            var e = void 0 !== this.currentDate && null !== this.currentDate ? this.currentDate : null,
        ...
        initHours: function () {
            ...
            for (var e = this.createSVGClock(!0), i = 0; i < 12; i++) {
                ...
                (h = this.createSVGElement("text", {
                    ...
                    fill: r,
                    "data-hour": i
                })).textContent = 0 === i && this.params.shortTime ? 12 : i, this.toggleTime(i, !0) ? (d.addEventListener("click", this._onSelectHour.bind(this)), h.addEventListener("click", this._onSelectHour.bind(this))) : (d.className += " disabled", h.className += " disabled", h.setAttribute("fill", "#bdbdbd")), e.appendChild(d), e.appendChild(h)
            }
            if (!this.params.shortTime) {
                for (i = 0; i < 12; i++) {
                    var h;
                    a = -110 * Math.sin(2 * -Math.PI * (i / 12)), s = -110 * Math.cos(2 * -Math.PI * (i / 12)), n = this.currentDate.format(t) == i + 12 ? "#26c6da" : "transparent", r = this.currentDate.format(t) == i + 12 ? "#fff" : "#000", d = this.createSVGElement("circle", {
                        id: "h-" + (i + 12),
                        class: "dtp-select-hour",
                        style: "cursor:pointer",
                        r: "30",
                    ...
                    (h = this.createSVGElement("text", {
                        ...
                        fill: r,
                        "data-hour": i + 12
                    })).textContent = i + 12, this.toggleTime(i + 12, !0) ? (d.addEventListener("click", this._onSelectHour.bind(this)), h.addEventListener("click", this._onSelectHour.bind(this))) : (d.className += " disabled", h.className += " disabled", h.setAttribute("fill", "#bdbdbd")), e.appendChild(d), e.appendChild(h)
                }
        ...
        initMinutes: function () {
            ...
            for (e = 0; e < 60; e++)
                if (e % 5 == 0) {
                    s = -162 * Math.sin(2 * -Math.PI * (e / 60)), n = -162 * Math.cos(2 * -Math.PI * (e / 60)), r = this.currentDate.format("m") == e ? "#fff" : "#000";
                    ...
                    h.textContent = e, this.toggleTime(e, !1) ? h.addEventListener("click", this._onSelectMinute.bind(this)) : (h.className += " disabled", h.setAttribute("fill", "#bdbdbd")), t.appendChild(h)
                } this._centerBox()
        },
        animateHands: function () {
            var t = this.currentDate.hour(),
                e = this.currentDate.minute();
            this.$dtpElement.find(".hour-hand")[0].setAttribute("transform", "rotate(" + 360 * t / 12 + ")"), this.$dtpElement.find(".minute-hand")[0].setAttribute("transform", "rotate(" + 360 * e / 60 + ")")
        },
            ...
            if (null !== t) {
                ...
                for (var r = a.date(); r <= s.date(); r++) {
                    if (r === a.date()) {
                        ...
                        if (d > 0)
                            for (var h = 0; h < d; h++) i.days.push(0)
                    }
        ...
        setElementValue: function () {
            this.$element.trigger("beforeChange", this.currentDate), void 0 !== t.material && this.$element.removeClass("empty"), this.$element.val(e(this.currentDate).locale(this.params.lang).format(this.params.format)), this.$element.trigger("change", this.currentDate)
        },
        ...
        toggleTime: function (t, i) {
            var a, s = !1;
            i ? ((a = e(this.currentDate)).hour(this.convertHours(t)).minute(0).second(0), s = !(!1 === this.isAfterMinDate(a, !0, !1) || !1 === this.isBeforeMaxDate(a, !0, !1))) : ((a = e(this.currentDate)).minute(t).second(0), s = !(!1 === this.isAfterMinDate(a, !0, !0) || !1 === this.isBeforeMaxDate(a, !0, !0)));
            return s
        },
        ...
        _onClearClick: function () {
            this.currentDate = null, this.$element.trigger("beforeChange", this.currentDate), this.hide(), void 0 !== t.material && this.$element.addClass("empty"), this.$element.val(""), this.$element.trigger("change", this.currentDate)
        },
        _onNowClick: function () {
            if (this.currentDate = e(), !0 === this.params.date && (this.showDate(this.currentDate), 0 === this.currentView && this.initDate()), !0 === this.params.time) {
        ...
        refreshYearItems: function () {
            var i = this.currentDate.year(),
                a = this.midYear,
                s = 1850;
            void 0 !== this.minDate && null !== this.minDate && (s = e(this.minDate).year());
            var n = 2200;
            void 0 !== this.maxDate && null !== this.maxDate && (n = e(this.maxDate).year()), this.$dtpElement.find(".dtp-picker-year .invisible").removeClass("invisible"), this.$dtpElement.find(".year-picker-item").each(function (e, r) {
                var d = a - 3 + e;
                t(r).attr("data-year", d).text(d).data("year", d), i == d ? t(r).addClass("active") : t(r).removeClass("active"), (d < s || d > n) && t(r).addClass("invisible")
            }), s >= a - 3 && this.$dtpElement.find(".dtp-select-year-range.before").addClass("invisible"), n <= a + 3 && this.$dtpElement.find(".dtp-select-year-range.after").addClass("invisible"), this.$dtpElement.find(".dtp-select-year-range").data("mid", a)
        },
        ...
        _onYearItemClick: function (e) {
            ...
            this.currentDate.add(i, "years"), this.initDate(this.currentDate), this._closeYearPicker(), this.$element.trigger("yearSelected", this.currentDate)
        },
        ...
        _onSelectDate: function (e) {
            this.$dtpElement.find("a.dtp-select-day").removeClass("selected"), t(e.currentTarget).addClass("selected"), this.selectDate(t(e.currentTarget).parent().data("date")), !0 === this.params.switchOnClick && !0 === this.params.time && setTimeout(this.initHours.bind(this), 200), !0 === this.params.switchOnClick && !1 === this.params.time && setTimeout(this._onOKClick.bind(this), 200)
        },
        _onSelectHour: function (e) {
            if (!t(e.target).hasClass("disabled")) {
                ...
                t(a.find("#h-" + i)).attr("fill", "#26c6da"), t(a.find("#th-" + i)).attr("fill", "#fff"), this.currentDate.hour(parseInt(i)), !0 === this.params.shortTime && this.isPM() && this.currentDate.add(12, "hours"), this.showTime(this.currentDate), this.animateHands(), !0 === this.params.switchOnClick && setTimeout(this.initMinutes.bind(this), 200)
            }
        },
        _onSelectMinute: function (e) {
            if (!t(e.target).hasClass("disabled")) {
                ...
                for (n = 0; n < r.length; n++) t(r[n]).attr("fill", "#000");
                t(a.find("#m-" + i)).attr("fill", "#26c6da"), t(a.find("#tm-" + i)).attr("fill", "#fff"), this.currentDate.minute(parseInt(i)), this.showTime(this.currentDate), this.animateHands(), !0 === this.params.switchOnClick && setTimeout(function () {
                    this.setElementValue(), this.hide()
                }.bind(this), 200)
            }
        },
        ...
        convertHours: function (t) {
            var e = t;
            return !0 === this.params.shortTime && t < 12 && this.isPM() && (e += 12), e
        },
        setDate: function (t) {
        ...
        show: function () {
            this.$dtpElement.removeClass("hidden"), this._attachEvent(t(window), "keydown", this._onKeydown.bind(this)), this._centerBox(), this.$element.trigger("open"), !0 === this.params.monthPicker && this._hideCalendar()
        },
        hide: function () {
            t(window).off("keydown", null, null, this._onKeydown.bind(this)), this.$dtpElement.addClass("hidden"), this.$element.trigger("close")
        },
        _centerBox: function () {
